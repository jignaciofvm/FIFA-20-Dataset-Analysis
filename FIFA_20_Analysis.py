...
with dataset:
    ...
    df = pd.read_csv('https://github.com/jignaciofvm/FIFA-20-Dataset-Analysis/blob/main/files/fifa20_data.csv', engine='python', encoding='utf8')
    df_similarity = pd.read_csv('https://github.com/jignaciofvm/FIFA-20-Dataset-Analysis/blob/main/files/df_similarity.csv', engine='python', encoding='utf8')
    st.write(df.head())
    st.text("""
