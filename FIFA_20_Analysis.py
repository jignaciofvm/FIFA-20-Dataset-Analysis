...
with dataset:
    ...
    df = pd.read_csv('https://github.com/jignaciofvm/FIFA-20-Dataset-Analysis/blob/main/files/fifa20_data.csv', sep = ',', header = True)
    df_similarity = pd.read_csv('https://github.com/jignaciofvm/FIFA-20-Dataset-Analysis/blob/main/files/df_similarity.csv', sep = ',', header = True)
    st.write(df.head())
    st.text("""
